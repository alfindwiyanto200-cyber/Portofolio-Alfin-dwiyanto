  ...
  return (
    <>
      ...
      <div className="w-full pt-10 md:pt-20 px-8 md:px-20 lg:px-32 mb-16 md:mb-32 relative z-10">
        <h1 className="text-6xl md:text-[9rem] leading-[1.05] font-normal tracking-tight w-full reveal active">
          {project.title}
        </h1>
      </div>

      <div className="w-full px-8 md:px-20 lg:px-32 mb-24 md:mb-32 relative z-10 reveal active fade-right">
      ...
      <div className="relative w-full mt-10">
        <div className="absolute top-0 left-[75%] md:left-[80%] -translate-x-1/2 -translate-y-1/2 z-20 reveal active">
        ...
        <div className="w-full bg-[#cbd0cd] py-24 md:py-40 px-4 md:px-12 lg:px-24 flex flex-col gap-12 items-center min-h-[50vh]">
          {project.images.map((img, i) => (
            <div key={i} className="w-full mb-12 last:mb-0 reveal active">
